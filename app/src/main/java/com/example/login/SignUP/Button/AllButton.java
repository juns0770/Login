...
public class AllButton {
    ...
    public void setAllButton(){
        Backpressbutton = (Button)aAllButton.findViewById(R.id.btn_backpress);   //!< 회원가입 뒤로가기버튼 id값 연결
        ...
        Signupbutton = (Button)aAllButton.findViewById(R.id.btn_signup); //!< 회원가입 id값 연결
