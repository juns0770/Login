...
public class AllsSpinner {
    ...
    public void setSpinner(){
        ...
        eamilspinner = (android.widget.Spinner) aAllsSpinner.findViewById(R.id.spinner_email);  //!< 이메일 스피너 id값 연결
        ...
        phonespinner = (android.widget.Spinner) aAllsSpinner.findViewById(R.id.spinner_phone);  //!< 전화번호 스피너 id값 연결
