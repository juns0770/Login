...
public class AllEditText {
    ...
    public AllEditText(AppCompatActivity appCompatActivity) {
        ...
        id = (EditText) aAllEditText.findViewById(R.id.edit_id);    //!< 아이디 id값 연결
        pw = (EditText) aAllEditText.findViewById(R.id.edit_pw);    //!< 비밀번호 id값 연결
        pwConfirm = (EditText) aAllEditText.findViewById(R.id.edit_pw2);    //!< 2차비밀번호 id값 연결
        phonenumber = (EditText) aAllEditText.findViewById(R.id.edit_phone);//!< 전화번호 id값 연결
        email = (EditText) aAllEditText.findViewById(R.id.edit_email);  //!< 이메일 id값 연결
    }
