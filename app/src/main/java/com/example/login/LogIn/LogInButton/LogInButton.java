...
public class LogInButton {
    ...
    public LogInButton(AppCompatActivity appCompatActivity) {
        ...
        id = (EditText) aLogInButton.findViewById(R.id.edit_id);   //!< 아이디 에딧텍스트 id값 연결
        pw = (EditText) aLogInButton.findViewById(R.id.edit_pw);   //!< 비밀번호 에딧텍스트 pw 값 연결
        setLogInButton();   //!< 로그인버튼 메서드

    }

    public void setLogInButton() {
        loginbutton = (Button) aLogInButton.findViewById(R.id.btn_login);    //!< 로그인버튼 id값 연결
